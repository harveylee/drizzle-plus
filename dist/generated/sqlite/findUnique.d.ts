...
//#region src/generated/sqlite/findUnique.d.ts
...
declare module 'drizzle-orm/sqlite-core/query-builders/query' {
  interface RelationalQueryBuilder<TMode extends 'sync' | 'async', TSchema extends TablesRelationalConfig, TFields extends TableRelationalConfig> {
     ...
     */
    findUnique<TConfig extends FindUniqueConfig<TSchema, TFields>>(config: KnownKeysOnly<TConfig, FindUniqueConfig<TSchema, TFields>>): SQLiteRelationalQuery<TMode, BuildQueryResult<TSchema, TFields, TConfig> | undefined>;
  }
}
//#endregion
